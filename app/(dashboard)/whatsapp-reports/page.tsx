...
function ConnectionPanel() {
    const [status, setStatus] = useState<{ configured: boolean; connected: boolean; loggedIn: boolean; state?: string } | null>(null);
    ...
    const handleGetQR = async () => {
        ...
        setQrcode(qrcode);
        setLoadingQR(false);
        // Auto-poll status every 5s for up to 60s after QR request
        let attempts = 0;
            ...
            <GlassCard className="space-y-5">
                ...
                <div className="space-y-3">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="text-[10px] text-muted-foreground">
                            Todos os relatórios automáticos serão enviados para este número.
                        </p>
                    </div>
                </div>
                ...
                {saveResult && (
                    <div className={cn(
                        ...
                        {saveResult.success
                            ? <><CheckCircle2 className="h-4 w-4 shrink-0" /> Configuração salva com sucesso!</>
                ...
                {isConnected ? (
                    <div className="text-center space-y-3">
                        ...
                        <p className="text-xs text-muted-foreground">
                            Relatórios automáticos estão prontos para envio.
                        </p>
                    </div>
                ) : qrcode ? (
                    <div className="text-center space-y-3">
