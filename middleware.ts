...
const PUBLIC_PATHS = ["/login", "/register", "/invite", "/api/auth/register", "/api/invites", "/api/webhooks", "/api/cron", "/favicon.svg", "/api/test-metrics", "/api/register", "/api/make-admin", "/home", "/api/debug/insights"];
